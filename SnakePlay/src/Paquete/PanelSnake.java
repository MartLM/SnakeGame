...
//            pintor.fillRect(res/2+snake.get(i)[0]*tam, res/2+snake.get(i)[1]*tam,
//                    tam-1, tam-1);
//        }
        //PINTADO DE SERPIENTE
        for(int[] par:snake){
            pintor.fillRect(res/2+par[0]*tam, res/2+par[1]*tam,
                    tam-1, tam-1);
        }
        
        //PINTADO DE COMIDA
        pintor.setColor(colorcomida);
        pintor.fillRect(res/2+comida[0]*tam, res/2+comida[1]*tam,
                    tam-1, tam-1);
